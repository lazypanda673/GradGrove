      ...
      <main>
        <CarouselFade images={carouselImages} interval={3500}>
          ...
          <AnimatedElement animation="scaleIn" delay={800}>
            <a href="/signup">
              <button className="hover-scale transition-all" style={{ fontSize: '1.15rem', padding: '14px 40px', background: 'var(--color-primary)', color: 'var(--color-background)', border: 'none', borderRadius: 14, cursor: 'pointer', marginTop: 18, boxShadow: '0 8px 32px #222', fontWeight: 700, letterSpacing: '0.5px', transition: 'background 0.2s, box-shadow 0.2s', position: 'relative', zIndex: 100 }}
                onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--color-secondary)'; e.currentTarget.style.boxShadow = '0 12px 48px #a3bffa66'; }}
                onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--color-primary)'; e.currentTarget.style.boxShadow = '0 8px 32px #222'; }}
              >Get Started</button>
            </a>
          </AnimatedElement>
        </CarouselFade>
