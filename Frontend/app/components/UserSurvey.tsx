...
export default function UserSurvey() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 350, margin: '40px auto' }}>
      ...
      <input type="number" placeholder="Stress Level (1-5)" value={stress} onChange={e => setStress(Number(e.target.value))} min={1} max={5} style={{ padding: 8, borderRadius: 4, border: '1px solid #ddd' }} />
